...
const BASE_STYLEBOX :=preload("res://scenes/cardUI/card_base_style_panel.tres")
const HOWER_STYLEBOX :=preload("res://scenes/cardUI/card_hower_style_panel.tres")
const DRAGGING_STYLEBOX :=preload("res://scenes/cardUI/card_dragging_style_panel.tres")
